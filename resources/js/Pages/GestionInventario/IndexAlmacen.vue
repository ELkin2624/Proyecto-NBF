<template>
    <div class="max-w-7xl mx-auto px-4 py-8">
        <h1 class="text-4xl font-bold text-center text-blue-600 mb-6">Gestión de Almacenes</h1>

        <!-- Botón para añadir inventario -->
        <div class="flex justify-end mb-4">
            <a href="/almacenes/create" class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded shadow-lg transition-all duration-300">
                Añadir Almacen
            </a>
        </div>
                ...
                <tbody>
                    <tr v-for="inventario in inventarios" :key="inventario.id_inventario" class="border-b hover:bg-gray-100 transition-all duration-200">
                        ...
                        <td class="py-2 px-4 flex space-x-2">
                            <a :href="`/almacenes/${inventario.id_inventario}/edit`" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-1 px-3 rounded shadow transition-all duration-300">Editar</a>
