<template>
    <div class="max-w-4xl mx-auto p-8 bg-white rounded-lg shadow-md">
        <h1 class="text-3xl font-bold text-center text-blue-600 mb-6">Crear Inventario</h1>
        <form @submit.prevent="submit" class="space-y-6">
            <div>
                ...
                <input
                    ...
                    placeholder="Introduce la ubicación del inventario"
                >
            </div>
            <div>
            ...
            <div class="flex justify-between items-center">
                <button
                    type="submit"
                    class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded shadow-lg transition-all duration-300"
                >
                    Crear Inventario
                </button>
                <a
